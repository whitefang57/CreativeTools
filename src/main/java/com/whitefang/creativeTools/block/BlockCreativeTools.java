package com.whitefang.creativeTools.block;
...
public class BlockCreativeTools extends Block{
	public BlockCreativeTools(Material material) {
		super(material);
	}

	public BlockCreativeTools() {
		this(Material.rock);
	}
